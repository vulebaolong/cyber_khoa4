    ...
    return (
        <div className={`${style.menu}`}>
            <div className={`${style.header}`}>
                ...
                <div className="sc-kafWEX eVrMiX">
                    <div className="sc-feJyhm jwrhXI">singularity 1.0</div>
                    <div className="sc-iELTvK fFTIzJ">Software project</div>
                </div>
            </div>
            <div className={`${style.body}`}>
                ...
                <div className={`${style.item} ${style.item_bottom}`}>
                    ...
                    <div className={`${style.item_bottom_text}`}>Releases</div>
                    <div className={`${style.not}`}>Not implemented</div>
                </div>
                ...
                <div className={`${style.item} ${style.item_bottom}`}>
                    ...
                    <div className={`${style.item_bottom_text}`}>Issues and filters</div>
                    <div className={`${style.not}`}>Not implemented</div>
                </div>
                ...
                <div className={`${style.item} ${style.item_bottom}`}>
                    ...
                    <div className={`${style.item_bottom_text}`}>Pages</div>
                    <div className={`${style.not}`}>Not implemented</div>
                </div>
                ...
                <div className={`${style.item} ${style.item_bottom}`}>
                    ...
                    <div className={`${style.item_bottom_text}`}>Reports</div>
                    <div className={`${style.not}`}>Not implemented</div>
                </div>
                ...
                <div className={`${style.item} ${style.item_bottom}`}>
                    ...
                    <div className={`${style.item_bottom_text}`}>Components</div>
                    <div className={`${style.not}`}>Not implemented</div>
                </div>
            </div>
        </div>
